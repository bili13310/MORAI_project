...
class Lkas:
    ...
    def img_wrap(self, img):
        ...
        dst = np.float32(
            [
                [int(dst_offset[0]), self.img_y],
                [int(dst_offset[0]), 0],
                [int(self.img_x - dst_offset[0]), 0],
                [int(self.img_x - dst_offset[0]), self.img_y],
            ]
        )

        cv2.circle(img, (int(dst_offset[0]), self.img_y), 10, (0,0,255), 10)
        cv2.circle(img, (int(dst_offset[0]), 0), 10, (0,0,255), 10)
        cv2.circle(img, (int(self.img_x - dst_offset[0]), 0), 10, (0,0,255), 10)
        cv2.circle(img, (int(self.img_x - dst_offset[0]), self.img_y), 10, (0,0,255), 10)
